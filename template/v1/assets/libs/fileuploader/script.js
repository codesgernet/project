	...
	$.fn.fileuploader.defaults = {
		...
		captions: {
			button: function (options) {
				return (options.limit == 1 ? 'Dosya': 'Dosyaları') + ' seçiniz' 
			},
			...
			download: 'İndir',
			remove: 'Sil',
			drop: 'Dosyaları buraya sürükleyerek yükle',
			paste: '<div class="fileuploader-pending-loader"><div class="left-half" style="animation-duration: ${ms}s"></div><div class="spinner" style="animation-duration: ${ms}s"></div><div class="right-half" style="animation-duration: ${ms}s"></div></div> Pasting a file, click here to cancel.',
			removeConfirmation: 'Bu dosyayı silmek istediğinizden emin misiniz?',
			errors: {
				filesLimit: 'Aynı anda Sadece ${limit} dosya yükleyebilrsiniz.',
				filesType: 'Sadece ${extensions} dosya türlerini yükleyebilirsiniz.',
				fileSize: '${name} boyut çok büyük! Lütfen ${fileMaxSize}MB\'a kadar dosya seçiniz.',
				filesSizeAll: 'Seçtiğini dosyaların boyutu çok büyük! Lütfen toplamda ${maxSize} MB\'a kadar dosya seçiniz.',
				fileName: '${name} isimli dosya zaten seçilmiş durumda. Tekrar seçemezsiniz.',
				folderUpload: 'Klasöre yükleminize izin verilmiyor.'
			}
		},
		/*
		captions: {
